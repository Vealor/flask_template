...
psql -h localhost -U itra itra_db -c "
  ...
  insert into paredown_rules (code) values ('210');
  ...
  insert into paredown_rules (code, comment) values ('221', 'Insurance');
  ...
  insert into paredown_rules (code, comment) values ('221', 'Payroll / Benefits');
  ...
  insert into paredown_rules (code) values ('209');
  ...
  insert into paredown_rules (code, comment) values ('221', 'Tolls');
  ...
  insert into paredown_rules (code) values ('208');
