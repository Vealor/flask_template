...
psql -h localhost -U itra itra_db -c "
  ...
  insert into paredown_rules (is_active, is_core, code) values ('f', 'f', '210');
  ...
  insert into paredown_rules (is_active, is_core, code, comment) values ('f', 'f', '221', 'Insurance');
  ...
  insert into paredown_rules (is_active, is_core, code, comment) values ('f', 'f', '221', 'Payroll / Benefits');
  ...
  insert into paredown_rules (is_active, is_core, code) values ('f', 'f', '209');
  ...
  insert into paredown_rules (is_active, is_core, code, comment) values ('f', 'f', '221', 'Tolls');
  ...
  insert into paredown_rules (is_active, is_core, code) values ('f', 'f', '208');
