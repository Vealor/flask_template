...
class Transaction(db.Model):
    ...
    def serialize(self):
        return {
            ...
            'gst_error_type': self.gst_error_type.name,
            ...
            'hst_error_type': self.hst_error_type.name,
            ...
            'qst_error_type': self.qst_error_type.name,
            ...
            'pst_error_type': self.pst_error_type.name,
            ...
            'apo_error_type': self.apo_error_type.name,
