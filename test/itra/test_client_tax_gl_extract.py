...
class TestClientTaxGLExtractGet():
    ...
    #     response = get_req('/itra/client_tax_gl_extract?project_id=1', client, token)
    #
    ...
    def test_get_client_tax_gl_extract_no_project_id(self, api, client):
        token = login(client, 'lh-admin', 'Kpmg1234%')
        response = get_req('/itra/client_tax_gl_extract', client, token)
    ...
    #     project_id = 1
    #     # create project
    #     response = get_req('/itra/client_tax_gl_extract?project_id=' + str(project_id), client, token)
