...
class TestClientVendorMasterGet():
    ...
    #     response = get_req('/ind_tax/client_vendor_master?project_id=1', client, token)
    #
    ...
    def test_get_client_vendor_master_no_project_id(self, api, client):
        token = login(client, 'lh-admin', 'Kpmg1234%')
        response = get_req('/ind_tax/client_vendor_master', client, token)
    ...
    #     project_id = 1
    #     # create project
    #     response = get_req('/ind_tax/client_vendor_master?project_id=' + str(project_id), client, token)
