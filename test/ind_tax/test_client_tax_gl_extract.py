...
class TestClientTaxGLExtractGet():
    ...
    #     response = get_req('/ind_tax/client_tax_gl_extract?project_id=1', client, token)
    #
    ...
    def test_get_client_tax_gl_extract_no_project_id(self, api, client):
        token = login(client, 'lh-admin', 'Kpmg1234%')
        response = get_req('/ind_tax/client_tax_gl_extract', client, token)
    ...
    def test_get_client_tax_gl_extract_project_no_exist(self, api, client):
        token = login(client, 'lh-admin', 'Kpmg1234%')
        response = get_req('/ind_tax/client_tax_gl_extract?project_id=-1', client, token)
    ...
    # def test_get_client_tax_gl_extract_project_no_capsgen(self, api, client):
    #     token = login(client, 'lh-admin', 'Kpmg1234%')
    #     project_id = 1
    #     # create project
    #     response = get_req('/ind_tax/client_tax_gl_extract?project_id=' + str(project_id), client, token)
