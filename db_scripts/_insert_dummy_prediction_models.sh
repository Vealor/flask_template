...
PGPASSWORD=LHDEV1234 psql -h localhost -U itra itra_db -c "
  ...
  INSERT INTO client_model_performances (precision, accuracy, recall, test_data_start, test_data_end, client_model_id) VALUES (0.12947389,0.5647857689,0.89568346,'2018-06-02','2018-10-31',4);
  INSERT INTO client_model_performances (precision, accuracy, recall, test_data_start, test_data_end, client_model_id) VALUES (0.12947389,0.5647857689,0.89568346,'2018-06-02','2018-10-31',5);
  INSERT INTO client_model_performances (precision, accuracy, recall, test_data_start, test_data_end, client_model_id) VALUES (0.135478,0.612567894,0.9568237624,'2019-06-02','2019-10-31',6);
  INSERT INTO client_model_performances (precision, accuracy, recall, test_data_start, test_data_end, client_model_id) VALUES (0.12947389,0.5647857689,0.89568346,'2019-06-02','2019-10-31',5);
  ...
  INSERT INTO master_model_performances (precision, accuracy, recall, test_data_start, test_data_end, master_model_id) VALUES (0.12947389,0.5647857689,0.89568346,'2018-06-02','2018-10-31',2);
