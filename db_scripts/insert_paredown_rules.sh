...
PGPASSWORD=$5 psql -h $1 -U $3 $4 -c "
  ...
  insert into paredown_rules (is_core, code_id, comment) values ('t', 34, 'Insurance');
  ...
  insert into paredown_rules (is_core, code_id, comment) values ('t', 34, 'Payroll / Benefits');
  ...
  insert into paredown_rules (is_core, code_id) values ('t', 30);
  ...
  insert into paredown_rules (is_core, code_id, comment) values ('t', 34, 'Tolls');
  ...
  insert into paredown_rules (is_core, code_id) values ('t', 29);
