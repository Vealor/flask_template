...
PGPASSWORD=$5 psql -h $1 -U $3 $4 -c "
  ...
  insert into projects (name, client_id, lead_partner_id, lead__manager_id) values ('North Mining', 1, 1, 1);
  insert into projects (name, client_id, lead_partner_id, lead__manager_id) values ('South Mining', 1, 1, 1);
  insert into projects (name, client_id, lead_partner_id, lead__manager_id) values ('Pipeline Northwest', 2, 1, 1);
  insert into projects (name, client_id, lead_partner_id, lead__manager_id) values ('Production Line CA', 3, 1, 1);
  insert into projects (name, client_id, lead_partner_id, lead__manager_id) values ('Production Line USA', 3, 1, 1);
  insert into projects (name, client_id, lead_partner_id, lead__manager_id) values ('Retail Unit S', 3, 1, 1);
  insert into projects (name, client_id, lead_partner_id, lead__manager_id) values ('Retail Unit N', 3, 1, 1);
