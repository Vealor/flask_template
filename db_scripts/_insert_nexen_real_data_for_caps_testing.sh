...
sed -i 's/|4|/|3|/g' ../sap_caps_uat.csv
sed -i 's/|4$/|3/g' ../sap_aps_uat.csv
...
) from '../sap_aps_uat.csv' HEADER DELIMITER '|' CSV QUOTE '\"' ESCAPE '''';"
...
profit_ctr_name,
vend_cntry
) from '../sap_caps_uat.csv' HEADER DELIMITER '|' CSV QUOTE '\"' ESCAPE '''';"
